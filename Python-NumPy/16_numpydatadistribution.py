...
vd = random.choice([3,5,7,9], p=[0.1, 0.3, 0.6, 0.0], size=(100))
print(vd)
...
for i in vd:
    if i == 3:
        ...
        v7.append(i)
print("Values of 3:", len(v3))
print("Values of 5:", len(v5))
print("Values of 7:", len(v7))
print("Total Values:", len(vd))
# now we will return 2-D with 3 rows each containing 5 values:
from numpy import random
vd = random.choice([3,5,7,9], p=[0.1, 0.3, 0.6, 0.0], size=(3, 5))
print(vd)
