...
import numpy as np
vd = np.array([[[1, 2, 3], [4, 5, 6]], [[1, 2, 3],[4, 5, 6]]])
print(vd)
...
import numpy as np
vd = np.array([1, 2, 3, 4, 5], ndmin=5)#conver the array to have 5 dimensions with ndmin argument
print(vd)
print('number of dimesions: ', vd.ndim)
